...
//    LineChart lineChart1;
    ...
    public static final float MAX = 180, MIN = -180; //-180~180度
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ysAsix.setAxisMinimum(0);
        ysAsix.setAxisMaximum(100); //we define min and max for axis
    ...
    private void setangleData(final int index) {
        ...
        databaseAngle.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(int i = 0; i < 3; i++) {
                    employee1.add(new RadarEntry(fingerangle.getMaxMpuAngle().get(i)));
                    employee2.add(new RadarEntry(fingerangle.getMinMpuAngle().get(i)));
                }
    ...
    private void setspeedData(final int index) {
        databaseAngle.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(int i = 0; i < 3; i++) {
                    employee1.add(new RadarEntry(fingerspeed.getMaxMpuSpeed().get(i)));
                }
