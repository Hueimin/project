...
public class Flappybee extends AppCompatActivity {

    public static final String GAME_NAME = "Flappy Bird";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_flappybee);
        ...
        databaseAngle.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ArrayAdapter timeList = new ArrayAdapter<>(Flappybee.this, android.R.layout.simple_spinner_dropdown_item, choice);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                angle.setFingerValue("Flappy Bird", time.get(position));
                speed.setFingerValue("Flappy Bird", time.get(position));
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog dialog = new AlertDialog.Builder(Flappybee.this)
                        .setTitle("Alert")
                ...
                positiveButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(Flappybee.this, deleteTime, Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
